...
//    self.isAccessibilityElement = YES;
    ...
    _mbglMap = new mbgl::Map(*_mbglView, size, scaleFactor, *mbglFileSource, mbgl::MapMode::Continuous, mbgl::GLContextMode::Unique, mbgl::ConstrainMode::None, mbgl::ViewportMode::Default);
